    ...
    configurationSchema: [
      {
        ...
        options: [
          ...
          { label: 'Purchase/supplier demo', value: 'supply-chain-demo' },
        ],
...
const DATASETS: Record<string, SJBLEntity[]> = {
  ...
  'supply-chain-demo': [
    { id: 'supplier-1', type: 'supplier', name: 'Accra Wholesale Ltd', email: 'procure@accrawholesale.example' },
    { id: 'product-2', type: 'product', name: 'Logistics Box', sku: 'LB-500', unitPrice: 42.5 },
    {
      id: 'po-1',
      type: 'purchase_order',
      ...
      date: '2026-06-25',
      items: [{ productId: 'product-2', quantity: 10, unitPrice: 42.5, total: 425 }],
      subtotal: 425,
      tax: 64,
      total: 489,
      currency: 'GHS',
    ...
    },
    {
      ...
      date: '2026-06-26',
      items: [{ productId: 'product-2', quantity: 1, unitPrice: 42.5, total: 42.5 }],
      subtotal: 42.5,
      tax: 6.38,
      total: 48.88,
      reason: 'Returned packaging',
      status: 'issued',
    },
  ] as unknown as SJBLEntity[],
};
